...
import getStarted from "/public/media/videos/moneyy.mp4";

export default function Hero() {
  return (
    <section className="w-full bg-gray pt-2.5">
      <div className="page_container md:max-w-full md:pl-4 md:pr-4">
        <div className="relative flex flex-col items-center  py-15 md:py-18 lg:py-20  rounded-xl lg:rounded-[0.875rem] bg-[linear-gradient(250deg,#E78D5C_1.2%,#2F8488_43.67%,#000_96.25%),linear-gradient(107deg,#672706_-2.13%,#024044_46.9%,#3A1E10_94.01%)]">
          {/* Background */}
